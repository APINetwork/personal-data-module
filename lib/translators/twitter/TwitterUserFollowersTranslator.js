...
function TwitterUserFollowersTranslator() {
}
TwitterUserFollowersTranslator.prototype.getMatchPatterns = function() {
  return [ '^acct:twitter:[0-9]+', '/relationship/incoming/confirmed' ];
};
TwitterUserFollowersTranslator.prototype.translate = function( uri, owner, rawDoc, callback ) {
  ...
  try {
    ...
    async.forEachSeries(followersData.users, function(follower, callback_s1) {
      ...
      var outputData = {
        'sourceUri': uri,
        'uri': 'apinetwork://' + owner + '//@' + source + '/follower/' + follower.id,
        'owner': owner,
        'category': 'follower',
...
TwitterUserFollowersTranslator.prototype.translateFollower = function(owner, source, rawFollower) {
...
module.exports = exports = TwitterUserFollowersTranslator;